...
function initialize(){
    ...
    function loadMarkerFirst(){
        $.getJSON('data/load-data-pelanggan.php',function(result){
            $.each(result,function(i,data){
                getMarker(new google.maps.LatLng(data.lat,data.lng),data.status,[data.kelurahan,data.golongan,data.status],data.pelanggan,createDescriptionInfoWindow(data.id_pelanggan,data.golongan,"modul/pelanggan/"+data.gambar_rumah,data.kelurahan,data.kelurahan,"modul/pelanggan/"+data.gambar_rumah,"modul/pelanggan/"+data.gambar_meter));
            });
        }).complete(function(){
